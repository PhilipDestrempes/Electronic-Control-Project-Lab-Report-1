...
The program can be used in configuration of a built in pull-up resistor 
and will show wether the pushbutton is on or off. 
*/
...
pinMode(pushbutton, INPUT_PULLUP);  // set pushbutton (pin13) as a input
